...
#define KRF_SYS_CALL open
#define KRF_SYS_PARMS const char __user *filename, int flags, umode_t mode
#define KRF_SYS_PARMSX filename, flags, mode
...
static typeof(sys_open)(*fault_table[]) = {
...
// Fault entrypoint.
long KRF_DEFINE_INTERNAL(open)(KRF_SYS_PARMS) {
