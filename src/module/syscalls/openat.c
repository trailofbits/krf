...
#define KRF_SYS_CALL openat
#define KRF_SYS_PARMS int dfd, const char __user *filename, int flags, umode_t mode
#define KRF_SYS_PARMSX dfd, filename, flags, mode
...
static typeof(sys_openat)(*fault_table[]) = {
...
// Fault entrypoint.
long KRF_DEFINE_INTERNAL(openat)(KRF_SYS_PARMS) {
